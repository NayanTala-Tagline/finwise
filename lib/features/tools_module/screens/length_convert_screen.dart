...
class LengthConvertScreen extends StatefulWidget {
  const LengthConvertScreen({super.key});

  @override
  State<LengthConvertScreen> createState() => _LengthConvertScreenState();
}

class _LengthConvertScreenState extends State<LengthConvertScreen> {
  ...
  double _convert(double v, String from, String to) {
    if (from == to) return v;
    return v * _toMeters[from]! / _toMeters[to]!;
  }
    ...
    return Column(
      ...
      children: [
        ...
        AppTextFormField(
          ...
          prefixIcon: Assets.temperatureIcons.icLengthConvert.svg(
            width: AppSize.w18,
            height: AppSize.w18,
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Assets.temperatureIcons.icLengthConvert.svg(
                        height: AppSize.h14,
                        width: AppSize.w14,
                        colorFilter: const ColorFilter.mode(
                          Colors.white,
